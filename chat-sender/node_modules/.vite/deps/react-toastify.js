...
import { __toESM, require_react } from "./react-CECw5MHl.js";
...
function Z(t, o, e = 300) {
	let { scrollHeight: r$1, style: s } = t;
	requestAnimationFrame(() => {
		s.minHeight = "initial", s.height = r$1 + "px", s.transition = `all ${e}ms`, requestAnimationFrame(() => {
			s.height = "0", s.padding = "0", s.margin = "0", setTimeout(o, e);
		});
	});
}
function $({ enter: t, exit: o, appendPosition: e = !1, collapse: r$1 = !0, collapseDuration: s = 300 }) {
	return function({ children: a, position: d, preventExitTransition: c, done: T, nodeRef: g, isIn: v, playToast: x }) {
		...
		return (0, import_react.useLayoutEffect)(() => {
			...
			let f = g.current, p = () => {
				f.removeEventListener("animationend", p), r$1 ? Z(f, T, s) : T();
			};
...
function gt({ delay: t, isRunning: o, closeToast: e, type: r$1 = "default", hide: s, className: l, controlledProgress: a, progress: d, rtl: c, isIn: T, theme: g }) {
	let v = s || a && d === 0, x = {
		animationDuration: `${t}ms`,
		animationPlayState: o ? "running" : "paused"
	};
	a && (x.transform = `scaleX(${d})`);
	let C = clsx_default("Toastify__progress-bar", a ? "Toastify__progress-bar--controlled" : "Toastify__progress-bar--animated", `Toastify__progress-bar-theme--${g}`, `Toastify__progress-bar--${r$1}`, { ["Toastify__progress-bar--rtl"]: c }), S = P(l) ? l({
		rtl: c,
		type: r$1,
		defaultClassName: C
	}) : clsx_default(C, l), E = { [a && d >= 1 ? "onTransitionEnd" : "onAnimationEnd"]: a && d < 1 ? null : () => {
		T && e();
	} };
	return import_react.createElement("div", {
		className: "Toastify__progress-bar--wrp",
		"data-hidden": v
	}, import_react.createElement("div", { className: `Toastify__progress-bar--bg Toastify__progress-bar-theme--${g} Toastify__progress-bar--${r$1}` }), import_react.createElement("div", {
		role: "progressbar",
...
var Xt = 1, at = () => `${Xt++}`;
function _t(t, o, e) {
	let r$1 = 1, s = 0, l = [], a = [], d = o, c = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Set(), g = (i) => (T.add(i), () => T.delete(i)), v = () => {
...
function X(t, o) {
	var r$1;
	if (o) return !!((r$1 = I.get(o)) != null && r$1.isToastActive(t));
	let e = !1;
	return I.forEach((s) => {
...
function Et(t) {
	...
	return {
		...
		setProps(e) {
			var r$1;
			(r$1 = I.get(o)) == null || r$1.setProps(e);
		},
		getSnapshot() {
			var e;
...
function Gt(t, { pending: o, error: e, success: r$1 }, s) {
	let l;
	...
	return c.then((T) => d("success", r$1, T)).catch((T) => d("error", e, T)), c;
}
y.promise = Gt;
y.success = Q("success");
y.info = Q("info");
...
function It(t) {
	var a;
	let { subscribe: o, getSnapshot: e, setProps: r$1 } = (0, import_react.useRef)(Et(t)).current;
	r$1(t);
...
function At(t) {
	let [o, e] = (0, import_react.useState)(!1), [r$1, s] = (0, import_react.useState)(!1), l = (0, import_react.useRef)(null), a = (0, import_react.useRef)({
		start: 0,
		delta: 0,
		removalDistance: 0,
		canCloseOnClick: !0,
	...
	return d && c && (h.onMouseEnter = p, t.stacked || (h.onMouseLeave = f)), v && (h.onClick = (m) => {
		...
		pauseToast: p,
		isRunning: o,
		preventExitTransition: r$1,
		toastRef: l,
		eventHandlers: h
	};
}
var Ot = typeof window != "undefined" ? import_react.useLayoutEffect : import_react.useEffect;
var G = ({ theme: t, type: o, isLoading: e,...r$1 }) => import_react.createElement("svg", {
	viewBox: "0 0 24 24",
	width: "100%",
	height: "100%",
...
function Nt({ theme: t, type: o, isLoading: e, icon: r$1 }) {
	let s = null, l = {
		theme: t,
		type: o
	};
	return r$1 === !1 || (P(r$1) ? s = r$1({
		...l,
		isLoading: e
	}) : (0, import_react.isValidElement)(r$1) ? s = (0, import_react.cloneElement)(r$1, l) : e ? s = W.spinner() : lo(o) && (s = W[o](l))), s;
}
var wt = (t) => {
	let { isRunning: o, preventExitTransition: e, toastRef: r$1, eventHandlers: s, playToast: l } = At(t), { closeButton: a, children: d, autoClose: c, onClick: T, type: g, hideProgressBar: v, closeToast: x, transition: C, position: S, className: E, style: f, progressClassName: p, updateId: b, role: i, progress: n, rtl: u, toastId: h, deleteToast: m, isIn: _, isLoading: k, closeOnClick: M, theme: A, ariaLabel: R } = t, D = clsx_default("Toastify__toast", `Toastify__toast-theme--${A}`, `Toastify__toast--${g}`, { ["Toastify__toast--rtl"]: u }, { ["Toastify__toast--close-on-click"]: M }), Y = P(E) ? E({
		rtl: u,
		position: S,
		type: g,
		defaultClassName: D
	}) : clsx_default(D, E), ft = Nt(t), dt = !!n || !c, j = {
		closeToast: x,
		type: g,
		theme: A
	}, H = null;
	...
	}, ft != null && import_react.createElement("div", { className: clsx_default("Toastify__toast-icon", { ["Toastify--animate-icon Toastify__zoom-enter"]: !k }) }, ft), tt(d, t, !o), H, !t.customProgressBar && import_react.createElement(gt, {
		...b && !dt ? { key: `p-${b}` } : {},
		rtl: u,
		theme: A,
		delay: c,
...
function Lt(t) {
	let o = {
		..._o,
		...t
	}, e = t.stacked, [r$1, s] = (0, import_react.useState)(!0), l = (0, import_react.useRef)(null), { getToastToRender: a, isToastActive: d, count: c } = It(o), { className: T, style: g, rtl: v, containerId: x, hotKeys: C } = o;
	function S(f) {
	...
	return Ot(() => {
		...
		if (e) {
			...
			Array.from(p).reverse().forEach((h, m) => {
				let _ = h;
				_.classList.add("Toastify__toast--stacked"), m > 0 && (_.dataset.collapsed = `${r$1}`), _.dataset.pos || (_.dataset.pos = i ? "top" : "bot");
				let k = n * (r$1 ? .2 : 1) + (r$1 ? 0 : b * m);
				_.style.setProperty("--y", `${i ? k : k * -1}px`), _.style.setProperty("--g", `${b}`), _.style.setProperty("--s", `${1 - (r$1 ? u : 0)}`), n += _.offsetHeight, u += .025;
			});
		}
	}, [
		r$1,
