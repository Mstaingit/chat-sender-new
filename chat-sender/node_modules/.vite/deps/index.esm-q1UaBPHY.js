...
//#endregion
export { Component, ComponentContainer, DEFAULT_ENTRY_NAME, Deferred, FirebaseError, LogLevel, Logger, Provider, SDK_VERSION, Sha1, _addComponent, _addOrOverwriteComponent, _apps, _clearComponents, _components, _getProvider, _isFirebaseApp, _isFirebaseServerApp, _isFirebaseServerAppSettings, _registerComponent, _removeServiceInstance, _serverApps, assert, assertionError, base64, base64Encode, contains, createMockUserToken, deepCopy, deepEqual, deleteApp, errorPrefix, getApp, getApps, getDefaultEmulatorHostnameAndPort, getGlobal, getModularInstance, getUA, initializeApp, initializeServerApp, isAdmin, isCloudWorkstation, isEmpty, isIndexedDBAvailable, isMobileCordova, isNodeSdk, isReactNative, isSafari, isSafariOrWebkit, isValidFormat, jsonEval, map, onLog, pingServer, querystring, registerVersion, safeGet, setLogLevel$1 as setLogLevel, stringLength, stringToByteArray, stringify, updateEmulatorBanner };
//# sourceMappingURL=index.esm-q1UaBPHY.js.map